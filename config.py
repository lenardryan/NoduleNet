...
data_config = {
    ...
    'annos_dir': BASE + 'Others/LIDC-XML-only/tcia-lidc-xml',

    # put lung mask downloaded from LUNA16 to this path
    'lung_mask_dir': BASE + 'Others/seg-lungs-LUNA16/seg-lungs-LUNA16/',
...
train_config = {
    ...
    'val_set_list': ['split/new/3_val.csv'],
    'test_set_name': 'split/new/3_val.csv',
    'label_types': ['mask'],
